...
@assignment_types[:sorting] = {
  quotes: {
    assignment_type_created: "Every maker of video games knows something that
      the makers of curriculum don't seem to understand. You'll never see a
      video game being advertised as being easy. Kids who do not like school
      will tell you it's not because it's too hard. It's because it's--boring
      ― Seymour Papert"
  },
  attributes: {
