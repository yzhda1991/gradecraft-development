...
@assignments[:standard_edit_quick_grade_checkbox] = {
  quotes: {
    assignment_created: "For me, I am driven by two main philosophies: know
      more today about the world than I knew yesterday and lessen the suffering
...
@assignments[:standard_edit_quick_grade_checkbox_graded] = {
  quotes: {
    assignment_created: "I hope you're pleased with yourselves. We could all
      have been killed - or worse, expelled. Now if you don't mind, I'm going to
      bed. ― J.K. Rowling"
  },
  assignment_type: :grading,
  attributes: {
...
@assignments[:standard_edit_quick_grade_select_assignment] = {
  quotes: {
    assignment_created: "What a school thinks about its library is a measure of
      what it feels about education.― Harold Howe",
  },
  assignment_type: :grading,
  attributes: {
...
@assignments[:threshold_and_insufficient_grades] = {
  ...
  attributes: {
    ...
    description: "Graded Assignment has a points threshold that no student met.
      Grades have a raw_score of 15000",
    open_at: 1.weeks.from_now,
    due_at: 1.weeks.from_now + 0.05,
    point_total: 20000,
...
@assignments[:self_log_score_level_assignment] = {
  quotes: {
    assignment_created: "I didn't give it much thought back then. I just wanted
      to get all the words straight and collect my A. ― Gayle Forman, Just One
      Day",
  },
  assignment_type: :grading,
  attributes: {
...
@assignments[:standard_edit_release_required] = {
  quotes: {
    assignment_created: "But what are schools for if not to make children fall
      so deeply in love with the world that they really want to learn about it?
      That is the true business of schools. And if they succeed in it, all other
      desirable developments follow of themselves. - Marjorie Spock",
  },
  assignment_type: :grading,
  attributes: {
...
@assignments[:rubric_assignment] = {
  quotes: {
    assignment_created: "We spend the first year of a child's life teaching it
      to walk and talk and the rest of its life to shut up and sit down. There's
      something wrong there. ― Neil deGrasse Tyson",
    rubric_created: "What is this? A center for ants? How can we be expected to
      teach children to learn how to read... if they can't even fit inside the
      building? --Derek Zoolander",
    submissions_created: "I was the intellectual equivalent of a 98-pound
      weakling! I would go to the beach and people would kick copies of Byron
      in my face! - John Keating",
...
@assignments[:rubric_assignment_graded] = {
  ...
  grade_attributes: {
    ...
    instructor_modified: true,
    raw_score: -> { 80000 },
    feedback: 'As Aristotle said, <strong>"The whole is greater than the sum of
      its parts."</strong>'
  },
  rubric: true,
  student_submissions: true
...
@assignments[:group_grade_submissions_assignment] = {
  quotes: {
    assignment_created: "Many highly talented, brilliant, creative people think
      they're not - because the thing they were good at at school wasn't valued,
      or was actually stigmatized. - Sir Ken Robinson",
  },
  assignment_type: :grading,
  attributes: {
...
@assignments[:group_grade_rubric_assignment] = {
  quotes: {
    assignment_created: "It does not matter how slowly you go as long as you do
      not stop.― Confucius",
    rubric_created: "They learn to unlearn, To redeem the fault of the people,
      To assist the nature of all things, Without daring to meddle. - Lao Tzu"
  },
  assignment_type: :grading,
  attributes: {
...
@assignments[:no_submissions_assignment] = {
  quotes: {
    assignment_created: "The answer is not to standardize education, but to
      personalize and customize it to the needs of each child and community.
      There is no alternative. There never was. –Ken Robinson",
  },
...
@assignments[:accepts_submissions_assignment] = {
  quotes: {
    assignment_created: "One recipe for one kind of fun: 1) Identify the
      inherent learnable challenge, 2) Restructure it optimally with clear
      goals, rules, and feedback, 3) Playtest and iterate –Sebastian Deterding",
  },
  assignment_type: :submissions,
  attributes: {
...
@assignments[:predictor_fixed_assignment_predicted] = {
  quotes: {
    assignment_created: "The whole educational and professional training system
      is a very elaborate filter, which just weeds out people who are too
      independent, and who think for themselves, and who don't know how to be
      submissive, and so on -- because they're dysfunctional to the
...
@assignments[:predictor_continuous_slider_assignment_predicted] = {
  quotes: {
    assignment_created: "We are students of words: we are shut up in schools,
      and colleges, and recitation -rooms, for ten or fifteen years, and come
...
@assignments[:invisible_assignment] = {
  quotes: {
    assignment_created: "Invisible Learning is a recognition that most of the
      ...
      non-formal, and serendipitous experiences rather than through formal
      instruction. --  John Moravec",
  },
...
@assignments[:visible_assignment] = {
  quotes: {
    assignment_created: "College: two hundred people reading the same book. An
      obvious mistake. Two hundred people can read two hundred books.
      ―John Cage",
  },
  assignment_type: :visibility,
  attributes: {
...
@assignments[:sends_email_notes_on_release] = {
  quotes: {
    assignment_created: "People tend to forget that play is serious.
      – David Hockney",
  },
...
@assignments[:sends_email_notes_immediately] = {
  quotes: {
    assignment_created: "Do not keep children to their studies by compulsion but
      by play. – Plato",
  },
  assignment_type: :notifications,
  attributes: {
...
@assignments[:hidden_analytics_on] = {
  quotes: {
    assignment_created: "People aren't either wicked or noble. They're like
      chef's salads, with good things and bad things chopped and mixed together
      in a vinaigrette of confusion and conflict. ― Lemony Snicket",
  },
  assignment_type: :analytics,
  attributes: {
...
@assignments[:groups_hidden_analytics_on] = {
  quotes: {
    assignment_created: "Life can only be understood backwards; but it must be
...
@assignments[:unlock_submission_condition] = {
  quotes: {
    assignment_created: "Now, it is the view of the Ministry that a theoretical
      knowledge will be more than sufficient to get you through your
...
@assignments[:unlock_grade_earned_by_date_condition] = {
  quotes: {
    assignment_created: "The 'polymath' had already died out by the close of
      ...
      The consequence is that today everyone is a mere technician, even the
...
@assignments[:grade_earned_by_date_is_an_unlock] = {
  quotes: {
    assignment_created: "Placing the burden on the individual to break down
      doors in finding better education for a child is attractive to
      conservatives because it reaffirms their faith in individual ambition and
      autonomy. But to ask an individual to break down doors that we have
...
@assignments[:unlock_feedback_read_condition] = {
  quotes: {
    assignment_created: "Generally in life, knowledge is acquired to be used.
      ...
      treated like money, to be put away in a bank for the future.
      ― Seymour Papert",
  },
  assignment_type: :unlocks,
  attributes: {
...
@assignments[:unlock_feedback_read_by_date_condition] = {
  quotes: {
    assignment_created: "Grandma calls it the Socratic Method. She considers it
      the highest pedagogical technique. I call it cornering a person. Instead
...
@assignments[:feedback_read_by_date_is_an_unlock] = {
  quotes: {
    assignment_created: "school people must not fall into the trap of thinking
      that early preparation for an unjust world requires early exposure to
      injustice ― Oakes Jeannie",
  },
  assignment_type: :unlocks,
  attributes: {
...
@assignments[:alphanum_1_condition] = {
  quotes: {
    assignment_created: "In a classical joke a child stays behind after school
      to ask a personal question. 'Teacher, what did I learn today?' The
      surprised teacher asks, 'Why do you ask that?' and the child replies,
      'Daddy always asks me and I never know what to say.' ― Seymour Papert",
  },
...
@assignments[:alphanum_2_condition] = {
  quotes: {
    assignment_created: "Nothing bothers me more than when people criticize my
      criticism of school by telling me that schools are not just places to
      learn maths and spelling, they are places where children learn a vaguely
      defined thing called socialization. I know. I think schools generally do
      an effective and terribly damaging job of teaching children to be
      infantile, dependent, intellectually dishonest, passive and disrespectful
      to their own developmental capacities. - Seymour Papert",
  },
  assignment_type: :sorting,
  attributes: {
    name: "Class 2",
...
@assignments[:alphanum_10_condition] = {
  quotes: {
    assignment_created: "Most learning is not the result of instruction. It is
      rather the result of unhampered participation in a meaningful setting.
      Most people learn best by being 'with it,' yet school makes them identify
...
@assignments[:alphanum_20_condition] = {
  quotes: {
    assignment_created: "Formal learning is like riding a bus: the driver
      ...
      Informal learning is like riding a bike: the rider chooses the
      destination, the speed, and the route.― Jay Cross",
  },
  assignment_type: :sorting,
  attributes: {
    name: "Class 20",
