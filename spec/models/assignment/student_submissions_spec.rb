...
describe "Assignment #student_submissions methods" do
  ...
  describe "#student_submissions_for_team" do
    ...
    let(:errant_team_submission) { create(:submission, assignment: assignment, student: student) }
    ...
    it "doesn't return submissions that don't belong to the assignment" do
      expect(subject).not_to include(errant_submission)
    end
