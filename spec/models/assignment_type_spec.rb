describe AssignmentType do
  ...
  describe "#visible_score_for_student(student)" do
    it "returns the student score if there is are no caps" do
      ...
      grade = create(:grade, student: student, raw_points: 1000, assignment: assignment, student_visible: true)
    ...
    it "returns the top X score if present" do
      ...
      grade = create(:grade, student: student, raw_points: 100, assignment: assignment, student_visible: true)
      grade_2 = create(:grade, student: student, raw_points: 75, assignment: assignment_2, student_visible: true)
      grade_3 = create(:grade, student: student, raw_points: 25, assignment: assignment_3, student_visible: true)
  ...
  describe "#score_for_student(student)" do
    it "returns the total score a student has earned for an assignment type" do
      ...
      assignment_2 = create(:assignment, course: course, assignment_type: assignment_type)
      grade = create(:grade, student: student, raw_points: 100, assignment: assignment, student_visible: true)
      grade = create(:grade, student: student, raw_points: 100, assignment: assignment_2, student_visible: true)
    ...
    it "returns the total score a student has earned for an assignment type and has a reduced final score" do
      assignment = create(:assignment, course: course, assignment_type: assignment_type)
      grade = create(:grade, student: student, raw_points: 100, adjustment_points: -25, assignment: assignment, student_visible: true)
  ...
  describe "#grades_for(student)" do
    ...
    it "returns grades with a score" do
      assignment = create(:assignment, course: course, assignment_type: assignment_type)
      assignment_2 = create(:assignment, course: course, assignment_type: assignment_type)
      grade = create(:grade, student: student, raw_points: nil, assignment: assignment, student_visible: true)
      grade_2 = create(:grade, student: student, raw_points: 100, assignment: assignment_2, student_visible: true)
    ...
    it "returns grades that are not excluded" do
      assignment = create(:assignment, course: course, assignment_type: assignment_type)
      assignment_2 = create(:assignment, course: course, assignment_type: assignment_type)
      grade = create(:grade, student: student, raw_points: 100, excluded_from_course_score: false, assignment: assignment, student_visible: true)
      grade_2 = create(:grade, student: student, raw_points: 100, excluded_from_course_score: true, assignment: assignment_2, student_visible: true)
      expect(assignment_type.grades_for(student)).to eq([grade])
    end
  ...
  describe "#final_points_for_student(student)" do
    it "returns the final score if present" do
      ...
      assignment = create(:assignment, course: course, assignment_type: assignment_type)
      create(:assignment_type_weight, student: student, course: course, assignment_type: assignment_type, weight: 3)
      grade = create(:grade, student: student, raw_points: 100, adjustment_points: -42, assignment: assignment, student_visible: true)
  ...
  describe "#max_points_for_student(student)" do
    it "returns the max point value for the type if present and the student has earned MORE than that cap" do
      ...
      assignment_type.max_points = 100
      assignment = create(:assignment, course: course, assignment_type: assignment_type, full_points: 99)
      grade = create(:grade, student: student, raw_points: 200, assignment: assignment, student_visible: true)
