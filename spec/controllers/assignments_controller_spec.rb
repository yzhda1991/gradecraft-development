  ...
  context "as a professor" do
    ...
    describe "GET export_structure" do
      it "retrieves the export_structure download" do
        ...
        expect(response.body).to include("Name,Assignment Type,Point Total,Description,Purpose,Open At,Due At,Accepts Submissions,Accept Until,Required,Assignment Id,Created At,Submissions Count,Grades Count,Learning Objectives")
      end
    end
