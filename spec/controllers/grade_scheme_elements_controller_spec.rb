  ...
  context "as professor" do
    ...
    describe "PUT mass_update" do
      it "updates the grade scheme elements all at once" do
        params = { "grade_scheme_elements_attributes" => [{ id: @grade_scheme_element.id, letter: "C", level: "Sea Slug", low_points: 0, high_points: 100000, course_id: @course.id }, { id: GradeSchemeElement.new.id, letter: "B", level: "Snail",
          low_points: 100001, high_points: 200000, course_id: @course.id }],
      ...
      it "does not save the changes if invalid" do
        ...
        params = { "grade_scheme_elements_attributes" => [{ id: @grade_scheme_element.id, letter: "C", level: "Sea Slugs Galore", low_points: 0, high_points: 100010, course_id: @course.id }, { id: GradeSchemeElement.new.id, letter: "B", level: "Snail",
          low_points: 100011, high_points: nil, course_id: @course.id}],
        "deleted_ids"=>nil, "grade_scheme_element"=>{} }
        put :mass_update, params.merge(format: :json)
        expect(@grade_scheme_element.reload.high_points).to eq(100000)
