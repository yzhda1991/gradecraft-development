@gradecraft = angular.module('gradecraft', ['restangular', 'ui.slider', 'uiFx', 'ui.sortable', 'ng-rails-csrf', 'ngResource', 'ngAnimate', 'ui.router', 'froala', 'fcsa-number', 'templates', 'fcsa-number','smart-number','lodash','helpers'])
