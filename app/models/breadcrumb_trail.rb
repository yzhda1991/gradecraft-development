class BreadcrumbTrail < Croutons::BreadcrumbTrail
  ...
  def assignments_importers_index
    ...
    breadcrumb("Import Assignments", assignments_importers_path)
  end
  
  def assignments_settings
    breadcrumb("Dashboard", dashboard_path)
    breadcrumb("Assignments", assignments_path)
    breadcrumb("Assignment Settings", assignments_settings_path)
  end
  ...
  def badges_new
    breadcrumb("Dashboard", dashboard_path)
    breadcrumb("Badges", badges_path)
    breadcrumb("New Badge", new_badge_path)
  end
  
  def challenges_index
    breadcrumb("Dashboard", dashboard_path)
    breadcrumb("Challenges", challenges_path)
  end
  ...
  def challenge_grades_edit
    ...
    breadcrumb("Challenges", challenges_path)
    breadcrumb(objects[:challenge].name, challenge_path(objects[:challenge]))
    breadcrumb("Editing Challenge Grade")
  end
  ...
  def challenges_challenge_grades_new
    ...
    breadcrumb("Challenges", challenges_path)
    breadcrumb(objects[:challenge].name, challenge_path(objects[:challenge]))
    breadcrumb("New Challenge Grade", new_challenge_challenge_grade_path(objects[:challenge]))
  end
  ...
  def courses_edit
    breadcrumb("Dashboard", dashboard_path)
    breadcrumb("Editing " + objects[:course].name, course_path(objects[:course]))
