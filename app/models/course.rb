...
class Course < ActiveRecord::Base
  ...
  # @mz todo: refactor this, maybe into a Gradebook class
  def csv_gradebook
    CSV.generate do |csv|
  ...
  # @mz todo: add unit tests for this somewhere else
  class Gradebook
    ...
    def student_data_for(student)
      ...
      # @mz todo: we need to pre-fetch the course teams for this
      student_data << student.team_for_course(@course).try(:name) 
      
      # add the grades for the necessary assignments, @mz todo: improve the performance here
  ...
  # @mz todo: needs to be refactored as a CSV exporter
