  ...
  def final_grades_for_course(course)
    CSV.generate do |csv|
      ...
      course.students.each do |student|
        csv << [student.first_name, student.last_name, student.email, student.username, student.cached_score_for_course(course), student.grade_letter_for_course(course), student.grade_level_for_course(course), student.earned_badges.count, student.id ]
      end
    end
  end
